...
class ProductController extends Controller
{
    ...
    {
        //ini fungsi untukmencari produk yg ingin diedit
        if (empty($id)) {
            return redirect('admin/products/create');
        }
        //variable yang digunakan untuk menyimpan kategori terakhir yg dipilih oleh kategori tersebut
        //cara memanggil kategiry dengan pluck diambil id menjadi array
    ...
    //ini untuk fungsi nambahin gambar, dengan logika rute create -> mencari id produk yang ingin ditambah ->gc_status get data dan merender view product id dan juga product images
